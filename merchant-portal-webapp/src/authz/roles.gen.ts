...
export const SCOPES: readonly Scope[] = ["collections:read", "ledger:read", "notifications:acknowledge", "notifications:read", "settlements:read"];
...
export const ROLE_GRANTS: Record<Role, readonly Scope[]> = {
  "Merchant": ["collections:read", "ledger:read", "notifications:acknowledge", "notifications:read", "settlements:read"],
};
